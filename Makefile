...
GENERATE=$(JCC) $(foreach jar,$(JARS),--jar $(jar)) \
           ...
           --rename org.apache.lucene.queryparser.surround.parser.FastCharStream=SurroundFastCharStream \
           --rename org.apache.lucene.queryparser.flexible.standard.parser.CharStream=FlexibleParserCharStream \
           --version $(LUCENE_VER) \
